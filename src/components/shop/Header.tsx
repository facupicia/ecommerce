...
const mainLinks = [
  ...
  { href: "/encargos/nuevo", label: "Encargos" },
];
        ...
        <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
          <div className="grid grid-cols-[1fr_auto_1fr] items-center h-[60px]">
            ...
            <div className="flex items-center justify-end gap-1">
              ...
              {/* Mi cuenta */}
              <Link href="/cuenta" className="p-2" aria-label="Mi cuenta">
                <svg
          ...
          >
            ...
            <nav className="flex-1 overflow-y-auto p-5 space-y-1">
              ...
              <div className="pt-3 border-t border-[#ebebeb]">
                <Link href="/cuenta" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 py-3 text-[13px] font-semibold uppercase tracking-[0.15em] text-[#1a1a1a] hover:text-[var(--plug-gray)] transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                  </svg>
                  Mi cuenta
                </Link>
                <Link href="/encargos/nuevo" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 py-3 text-[13px] font-semibold uppercase tracking-[0.15em] text-[#1a1a1a] hover:text-[var(--plug-gray)] transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
