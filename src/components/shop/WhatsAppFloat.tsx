...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 flex items-center justify-center bg-[#25d366] rounded-full text-white shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 group"
      aria-label="Contactar por WhatsApp"
    >
      <span className="absolute inset-0 rounded-full bg-[#25d366] opacity-40 animate-[ping_1.8s_cubic-bezier(0.215,0.61,0.355,1)_infinite]" />
...
// Keep the old keyframes for backward compat if needed
// ping is already in tailwind, but we define a fallback
