...
export default function OrderConfirmedPage() {
  return (
    <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10 py-24 text-center">
      ...
      <h1 className="kith-font-serif text-3xl sm:text-4xl text-[#333333] mb-3">
        ¡Pedido confirmado!
      </h1>
      <p className="text-[14px] text-[#828282] mb-2 max-w-md mx-auto">
        Gracias por tu compra. Te vamos a contactar pronto para coordinar el
        envío y el pago.
      </p>
      <p className="text-[12px] text-[#828282] mb-8">
